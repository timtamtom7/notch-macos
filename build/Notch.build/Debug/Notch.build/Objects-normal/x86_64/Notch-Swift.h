...
#ifndef NOTCH_SWIFT_H
#define NOTCH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Notch",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5Notch11AppDelegate")
...
@class NSCoder;
SWIFT_CLASS("_TtC5Notch16NotchContentView")
...
@class NSWindow;
SWIFT_CLASS("_TtC5Notch21NotchWindowController")
@interface NotchWindowController : NSWindowController
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
@class CLLocation;
SWIFT_CLASS("_TtC5Notch14WeatherService")
